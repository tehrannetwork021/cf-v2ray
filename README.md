...
توجه داشته باشید که در بخش Address  از ایپی تمیز با این سایت ها استفاده کنید ،  نام ساب دامنه‌ای که به ورکر متصل کرده‌اید در قسمت host قرار گرفته و نباید تغییر کند. 🔑
