...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Cloudflare-workers/pages-Vless proxy script V24.12.13</h1>
	    <hr>
            <p>${noteshow}</p>
            <hr>
	    <hr>
	    <hr>
            <br>
            <br>
            <h3>1：1: CF-workers-Vless+ws node</h3>
			<table class="table">
				<thead>
					<tr>
						<th>Node Feature：</th>
				...
				<tbody>
					<tr>
						<td class="limited-width">TLS encryption has been turned off, ignoring domain blocking</td>
            ...
            <ul>
                <li>Client address：Custom domain or preferred domain or preferred IP or reverse proxy IP</li>
                <li>Port: 7 HTTP ports can be arbitrarily selected (80, 8080, 8880, 2052, 2082, 2086, 2095), or the port corresponding to the reverse proxy IP</li>
                <li>User ID (UUID): ${userID}</li>
                <li>Transport protocol (network): ws or WebSocket</li>
                <li>Disguised domain (host): ${hostName}</li>
                <li>Path: /?ed=2560</li>
		<li>Transport security (TLS): Off</li>
            </ul>
            <hr>
			<hr>
			<hr>
            ...
            <h5>The client parameters are as follows：</h5>
            <ul>
                <liClient address (address): Custom domain name, preferred domain name, preferred IP, or reverse proxy IP</li>
                <li>Port (port): Any of the six HTTPS ports can be selected (443, 8443, 2053, 2083, 2087, 2096), or the corresponding port of the reverse proxy IP</li>
                <li>User ID (uuid): ${userID}</li>
                <li>Transport protocol (network): ws or websocket</li>
                <li>Obfuscated domain (host): ${hostName}</li>
                <li>Path (path): /?ed=2560</li>
                <li>Transport security (TLS): Enabled</li>
			...
			<hr>
			<p>Note：<br>1、By default, each subscription link includes a total of 13 port nodes with both TLS and non-TLS options<br>2、The current Workers domain is used as the subscription link and requires a proxy for subscription updates<br>3、If the client in use does not support the sharding function, TLS nodes will be unavailable</p>
			<hr>
			...
			<table class="table">
					<thead>
						<tr>
							<th>General Aggregation Share Link (Can be directly imported into the client)：</th>
						</tr>
					</thead>
					<tbody>
						<tr>
			...
			<table class="table">
					<thead>
						<tr>
							<th>General Aggregation Subscription Link：</th>
						</tr>
					</thead>
					<tbody>
						<tr>
    ...
    <div class="row">
        <div class="col-md-12">
			...
			<table class="table">
				...
				<tbody>
					<tr>
						<td class="limited-width">TLS encryption has been enabled，<br>If the client supports the Fragment feature, it can be enabled to prevent domain blocking</td>
						<td class="limited-width">${p\u0076\u006c\u0065\u0073\u0073wstls}</td>
						<td><button class="btn btn-primary" onclick="copyToClipboard('${p\u0076\u006c\u0065\u0073\u0073wstls}')">Click to copy link</button></td>
					</tr>
				</tbody>
            ...
            <h5>The client parameters are as follows：</h5>
            <ul>
                <li>Client address (address): Custom domain name, preferred domain name, preferred IP, or reverse proxy IP</li>
                <li>Port (port): Any of the six HTTPS ports can be selected (443, 8443, 2053, 2083, 2087, 2096), or the corresponding port of the reverse proxy IP</li>
                <li>User ID (uuid): ${userID}</li>
                <li>Transport protocol (network): ws or websocket</li>
                <li>Obfuscated domain (host): ${hostName}</li>
            ...
            <br>
            <br>
			<h3>2: The subscription links for General Aggregation, Clash-meta, and Sing-box are as follows:</h3>
			<hr>
			<p>Note: The following subscription links only include 6 TLS port nodes.</p>
			<hr>
